...
- (void)sendALURequstWithResult:(ALUResult)result{
   ...
   // NSLog(@"hmac\n%@",hmac);
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:@"https://secure.ypmn.ru/order/alu/v3"] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:30.0f];
